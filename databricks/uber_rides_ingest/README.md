...
This folder defines all source code for the 'uber_rides_ingest 2' pipeline:
...
* Take a look at the sample under "sample_users_uber_rides_ingest_2.py" to get familiar with the syntax.
